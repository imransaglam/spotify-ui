      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
            ...
            Positioned(
                left: 100, top: 100, child: Image.asset("assets/spotify.png")),
            Positioned(
                left: 80, top: 170, child: Image.asset("assets/stext.png")),
            Positioned(
              left: 30,
              bottom: 100,
              child: Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            border: OutlineInputBorder(
                              ...
                              borderSide: BorderSide(
                                  width: 3, color: Color(0xff1ed760)),
                            ),
                            labelText: 'Email or Username',
                            labelStyle: TextStyle(
                                color: Color(0xff1ed760), fontSize: 14),
                            suffixIcon: Icon(Icons.mail_outline_outlined,
                                color: Color(0xff1ed760), size: 23)),
                      ),
                    ),
                    Container(
                      height: 32,
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffixIcon: Icon(Icons.visibility_off_outlined,
                                color: Color(0xffdadada), size: 23)),
                      ),
                    ),
                    Row(
                      children: [
